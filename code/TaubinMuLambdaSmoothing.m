classdef TaubinMuLambdaSmoothing<handle
    ...
    methods
        ...
        function obj = TaubinMuLambdaSmoothing(signalIn,nHoodRad,sig)
           ...
           % set default parameters
            ...
            % Tind the optimal filter's parameters
            ...
            obj.PlotFrequencyPolynomial(lambda,mu,numSteps,obj.params.kSb,obj.params.kPb)
            
            % Calculate and display the signal FFT
            obj.CalculateSignalFFT(obj.signalIn);
            ...
            % Compare signal in and out
            obj.DisplaySmoothSignal(obj.signalIn,obj.signalOut)
            
            % Display fft after smoothing
            obj.CalculateSignalFFT(obj.signalOut)            
        end
    end
