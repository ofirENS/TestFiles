classdef CalculateBeadDistancesByRouseModel<handle
    ...
    methods
        ...
        function SetDefaultParams(obj)
            obj.beadRange      = struct('bead1',107:207,...
                                        'bead2',107:207);
            obj.smoothingSpan  = 3;
            ...
            obj.beadsToAnalyze = 1:100; % for what beads to show the connectivity graphs
            ...
            for bIdx = 1:size(obj.encounterMat,1);
                ...
                if ~all(isnan(observedProb))
                    ...
                    for kIdx = 1:numel(k)-1
                        ...
                        below{bIdx,kIdx} = dists{bIdx,kIdx}(find(dists{bIdx,kIdx}<kIdx));                                                
