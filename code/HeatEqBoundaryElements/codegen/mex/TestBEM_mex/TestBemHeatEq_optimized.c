...
static emlrtRSInfo de_emlrtRSI = { 87, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo ee_emlrtRSI = { 88, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo fe_emlrtRSI = { 90, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo ge_emlrtRSI = { 91, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo he_emlrtRSI = { 93, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo ie_emlrtRSI = { 94, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo je_emlrtRSI = { 99, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo ke_emlrtRSI = { 100, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo le_emlrtRSI = { 108, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo me_emlrtRSI = { 109, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo ne_emlrtRSI = { 122, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo oe_emlrtRSI = { 123, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo pe_emlrtRSI = { 124, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo qe_emlrtRSI = { 125, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo re_emlrtRSI = { 127, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo se_emlrtRSI = { 130, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo te_emlrtRSI = { 132, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo ue_emlrtRSI = { 135, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo ve_emlrtRSI = { 137, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo we_emlrtRSI = { 139, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo xe_emlrtRSI = { 141, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo ye_emlrtRSI = { 154, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo af_emlrtRSI = { 155, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo bf_emlrtRSI = { 156, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo cf_emlrtRSI = { 160, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo df_emlrtRSI = { 166, "TestBemHeatEq_optimized",
  "D:\\Ofir\\ENS\\TestFiles\\code\\New folder\\TestBemHeatEq_optimized.m" };

static emlrtRSInfo ef_emlrtRSI = { 79, "colon",
  "D:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\ops\\colon.m" };

static emlrtRSInfo ff_emlrtRSI = { 283, "colon",
  "D:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\ops\\colon.m" };

static emlrtRSInfo gf_emlrtRSI = { 291, "colon",
  "D:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\ops\\colon.m" };

static emlrtRSInfo uf_emlrtRSI = { 68, "eml_mtimes_helper",
  "D:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\ops\\eml_mtimes_helper.m"
};

static emlrtRSInfo vf_emlrtRSI = { 54, "eml_xgemm",
  "D:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\eml\\blas\\eml_xgemm.m"
};

static emlrtRSInfo wf_emlrtRSI = { 1, "xgemm",
...
static emlrtRSInfo eg_emlrtRSI = { 404, "colon",
  "D:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\ops\\colon.m" };

static emlrtRSInfo ng_emlrtRSI = { 405, "colon",
  "D:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\ops\\colon.m" };
  ...
  emxArray_real_T *r)
{
  ...
  char_T cv54[8];
  static const char_T cv55[8] = { 'n', 'e', 'x', 't', 'P', 'l', 'o', 't' };

  const mxArray *l_y;
  static const int32_T iv56[2] = { 1, 3 };

  char_T cv56[3];
  static const char_T cv57[3] = { 'A', 'd', 'd' };
  ...
  char_T cv58[5];
  static const char_T cv59[5] = { 'X', 'D', 'a', 't', 'a' };

  const mxArray *n_y;
  static const int32_T iv58[2] = { 1, 5 };

  static const char_T cv60[5] = { 'Y', 'D', 'a', 't', 'a' };

  const mxArray *o_y;
  real_T *pData;
  const mxArray *p_y;
  static const int32_T iv59[2] = { 1, 11 };

  char_T cv61[11];
  static const char_T cv62[11] = { 'D', 'i', 's', 'p', 'l', 'a', 'y', 'N', 'a',
    'm', 'e' };

  const mxArray *q_y;
  static const int32_T iv60[2] = { 1, 6 };

  static const char_T cv63[6] = { 'S', 'o', 'u', 'r', 'c', 'e' };

  const mxArray *r_y;
  static const int32_T iv61[2] = { 1, 5 };

  static const char_T cv64[5] = { 'C', 'o', 'l', 'o', 'r' };
  ...
  const mxArray *w_y;
  static const int32_T iv65[2] = { 1, 11 };

  const mxArray *x_y;
  static const int32_T iv66[2] = { 1, 11 };

  static const char_T cv65[11] = { 'h', 'e', 'a', 't', ' ', 'e', 'n', 'e', 'r',
    'g', 'y' };
  ...
  const mxArray *ab_y;
  const mxArray *bb_y;
  static const int32_T iv68[2] = { 1, 6 };

  static const char_T cv66[6] = { 'p', 'a', 'r', 'e', 'n', 't' };
  ...
  const mxArray *eb_y;
  const mxArray *fb_y;
  static const int32_T iv71[2] = { 1, 11 };

  const mxArray *gb_y;
  static const int32_T iv72[2] = { 1, 4 };

  char_T cv67[4];
  static const char_T cv68[4] = { 'u', '(', 't', ')' };
  ...
  const mxArray *ib_y;
  const mxArray *jb_y;
  static const int32_T iv74[2] = { 1, 6 };
  ...
  for (i30 = 0; i30 < 10; i30++) {
    i31 = sigIn->size[1];
    i32 = 1 + i30;
    emlrtDynamicBoundsCheckFastR2012b(i32, 1, i31, &tc_emlrtBCI, sp);
  }
  ...
  if (!(2147483647U < ndbl)) {
    ...
    emlrtInitCharArrayR2013a(&d_st, 21, m10, cv47);
    emlrtAssign(&y, m10);
    e_st.site = &eg_emlrtRSI;
    f_st.site = &ng_emlrtRSI;
    error(&e_st, message(&f_st, y, &k_emlrtMCI), &l_emlrtMCI);
  }
  ...
  for (k = 0; k < 3; k++) {
    ...
    for (i30 = 0; i30 < 2; i30++) {
      iv43[i30] = r13->size[i30];
    }

    emlrtSizeEqCheck2DFastR2012b(d_regTerm, iv43, &x_emlrtECI, sp);
    for (i30 = 0; i30 < 2; i30++) {
      e_C[i30] = B->size[i30];
    }
    ...
    if (!(X->size[1] == D->size[0])) {
      if (((X->size[0] == 1) && (X->size[1] == 1)) || ((D->size[0] == 1) &&
        ...
        emlrtInitCharArrayR2013a(&b_st, 45, m10, cv49);
        emlrtAssign(&b_y, m10);
        c_st.site = &cg_emlrtRSI;
        g_st.site = &lg_emlrtRSI;
        error(&c_st, message(&g_st, b_y, &f_emlrtMCI), &g_emlrtMCI);
      } else {
        c_y = NULL;
        ...
        emlrtInitCharArrayR2013a(&b_st, 21, m10, cv47);
        emlrtAssign(&c_y, m10);
        c_st.site = &dg_emlrtRSI;
        g_st.site = &mg_emlrtRSI;
        error(&c_st, message(&g_st, c_y, &h_emlrtMCI), &i_emlrtMCI);
      }
    }
    ...
    emlrtSizeEqCheck2DFastR2012b(e_C, iv43, &u_emlrtECI, sp);
    ixstart = s1->size[0];
    i30 = r11->size[0];
    r11->size[0] = ixstart;
    ...
    iv46[0] = r11->size[0];
    iv46[1] = r12->size[0];
    emlrtSubAssignSizeCheckR2012b(iv46, 2, *(int32_T (*)[2])c_C->size, 2,
      &o_emlrtECI, sp);
    ixstart = c_C->size[1];
    for (i30 = 0; i30 < ixstart; i30++) {
      ix = c_C->size[0];
    ...
    emlrtSizeEqCheck2DFastR2012b(b_b1k, iv43, &q_emlrtECI, sp);
    ...
    if (!(X->size[1] == C->size[0])) {
      if ((X->size[0] == 1) && (X->size[1] == 1)) {
        ...
        c_st.site = &cg_emlrtRSI;
        g_st.site = &lg_emlrtRSI;
        error(&c_st, message(&g_st, d_y, &f_emlrtMCI), &g_emlrtMCI);
      } else {
        e_y = NULL;
        ...
        c_st.site = &dg_emlrtRSI;
        g_st.site = &mg_emlrtRSI;
        error(&c_st, message(&g_st, e_y, &h_emlrtMCI), &i_emlrtMCI);
      }
    }
    ...
    for (i30 = 0; i30 < 2; i30++) {
      iv43[i30] = r14->size[i30];
    }

    emlrtSizeEqCheck2DFastR2012b(e_C, iv43, &p_emlrtECI, sp);
    ixstart = s2->size[0];
    i30 = r11->size[0];
    r11->size[0] = ixstart;
    emxEnsureCapacity(sp, (emxArray__common *)r11, i30, (int32_T)sizeof(int32_T),
    ...
    iv49[0] = r11->size[0];
    emlrtSubAssignSizeCheckR2012b(iv49, 1, *(int32_T (*)[1])d_C->size, 1,
      &n_emlrtECI, sp);
    ixstart = d_C->size[0];
    for (i30 = 0; i30 < ixstart; i30++) {
  ...
  if (!(b1k->size[1] == X->size[0])) {
    if (((b1k->size[0] == 1) && (b1k->size[1] == 1)) || ((X->size[0] == 1) &&
      ...
      c_st.site = &cg_emlrtRSI;
      g_st.site = &lg_emlrtRSI;
      error(&c_st, message(&g_st, f_y, &f_emlrtMCI), &g_emlrtMCI);
    } else {
      g_y = NULL;
      ...
      c_st.site = &dg_emlrtRSI;
      g_st.site = &mg_emlrtRSI;
      error(&c_st, message(&g_st, g_y, &h_emlrtMCI), &i_emlrtMCI);
    }
  }
  ...
  if (!(b1k->size[1] == Y->size[0])) {
    if (((b1k->size[0] == 1) && (b1k->size[1] == 1)) || (Y->size[0] == 1)) {
      ...
      c_st.site = &cg_emlrtRSI;
      g_st.site = &lg_emlrtRSI;
      error(&c_st, message(&g_st, h_y, &f_emlrtMCI), &g_emlrtMCI);
    } else {
      i_y = NULL;
      ...
      c_st.site = &dg_emlrtRSI;
      g_st.site = &mg_emlrtRSI;
      error(&c_st, message(&g_st, i_y, &h_emlrtMCI), &i_emlrtMCI);
    }
  }
    ...
    while (i <= sigIn->size[1] - 1) {
      ...
      while (stIdx <= sigIn->size[1] - 1) {
        ...
        sTime = ((((sTime + Acoeff(&st, 0.0, 1.0 + (real_T)stIdx, x[j], t->
          ...
          &wc_emlrtBCI, sp) - 1], gridT) * 0.0) - Bcoeff(&h_st, 0.0, 1.0 +
                   (real_T)stIdx, x[j], t->
                   data[emlrtDynamicBoundsCheckFastR2012b(apnd, 1, ix,
                    &xc_emlrtBCI, sp) - 1], gridT) * 0.0) - Bcoeff(&h_st, 1.0,
  ...
  if (plotFlag) {
    ...
    emlrtInitCharArrayR2013a(&st, 8, m10, cv54);
    emlrtAssign(&k_y, m10);
    l_y = NULL;
    ...
    emlrtInitCharArrayR2013a(&st, 3, m10, cv56);
    emlrtAssign(&l_y, m10);
    b_st.site = &xg_emlrtRSI;
    emlrtAssign(&ax, axes(&b_st, j_y, emlrtAlias(fig), k_y, l_y, &w_emlrtMCI));
    m_y = NULL;
    ...
    emlrtInitCharArrayR2013a(&st, 5, m10, cv58);
    emlrtAssign(&m_y, m10);
    n_y = NULL;
    ...
    emlrtInitCharArrayR2013a(&st, 11, m10, cv61);
    emlrtAssign(&p_y, m10);
    q_y = NULL;
    ...
    line(&b_st, m_y, b_emlrt_marshallOut(t), n_y, o_y, p_y, q_y, r_y, s_y, t_y,
    ...
    line(&b_st, u_y, b_emlrt_marshallOut(t), v_y, b_emlrt_marshallOut(sigIn),
         w_y, x_y, y_y, ab_y, bb_y, emlrtAlias(ax), &y_emlrtMCI);
    ...
    emlrtInitCharArrayR2013a(&st, 4, m10, cv67);
    ...
    line(&b_st, cb_y, b_emlrt_marshallOut(t), db_y, eb_y, fb_y, gb_y, hb_y, ib_y,
         jb_y, emlrtAlias(ax), &ab_emlrtMCI);
