/*
 * TestBEM_mex_emxutil.h
 *
 * Code generation for function 'TestBEM_mex_emxutil'
 *
 */

#ifndef __TESTBEM_MEX_EMXUTIL_H__
#define __TESTBEM_MEX_EMXUTIL_H__
...
/* End of code generation (TestBEM_mex_emxutil.h) */
