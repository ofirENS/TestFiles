...
static const mxArray *c_emlrt_marshallOut(const emxArray_real_T *u)
{
  ...
  const mxArray *m18;
  y = NULL;
  m18 = emlrtCreateNumericArray(2, iv62, mxDOUBLE_CLASS, mxREAL);
...
static const mxArray *e_emlrt_marshallOut(const emxArray_real_T *u)
{
  ...
  const mxArray *m20;
  y = NULL;
  m20 = emlrtCreateNumericArray(2, iv64, mxDOUBLE_CLASS, mxREAL);
  ...
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  ...
  emlrtCheckVsBuiltInR2012b(sp, msgId, src, "double", false, 2U, iv66, bv0, iv67);
  ret->size[0] = iv67[0];
  ret->size[1] = iv67[1];
  ...
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  ...
  emlrtCheckVsBuiltInR2012b(sp, msgId, src, "double", false, 2U, iv68, bv2, iv69);
  ret->size[0] = iv69[0];
  ret->size[1] = iv69[1];
  ret->allocatedSize = ret->size[0] * ret->size[1];
  ret->data = (real_T *)mxGetData(src);
  ...
  emlrtMsgIdentifier *msgId, emxArray_real_T *ret)
{
  ...
  iv70[0] = -1;
  bv3[0] = true;
  emlrtCheckVsBuiltInR2012b(sp, msgId, src, "double", false, 1U, iv70, bv3, iv71);
  ret->size[0] = iv71[0];
