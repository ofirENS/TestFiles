...
static emlrtRSInfo eg_emlrtRSI = { 1, "mldivide",
  "D:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\ops\\mldivide.p"
};

static emlrtRSInfo fg_emlrtRSI = { 117, "eml_lusolve",
  "D:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\eml\\eml_lusolve.m"
};

static emlrtRSInfo gg_emlrtRSI = { 128, "eml_lusolve",
  "D:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\eml\\eml_lusolve.m"
};

static emlrtRSInfo hg_emlrtRSI = { 130, "eml_lusolve",
  "D:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\eml\\eml_lusolve.m"
};
  ...
  emxArray_real_T *B, emxArray_real_T *Y)
{
  ...
  const mxArray *m14;
  char_T cv80[8];
  static const char_T cv81[8] = { '%', '%', '%', 'd', '.', '%', 'd', 'e' };
  ...
  if (mn > 0) {
    ...
    while ((!exitg1) && (k <= mn - 1)) {
      if (muDoubleScalarAbs(b_A->data[k + b_A->size[0] * k]) <= xnorm) {
        st.site = &lc_emlrtRSI;
        y = NULL;
        m14 = emlrtCreateCharArray(2, iv80);
        for (i = 0; i < 8; i++) {
          cv80[i] = cv81[i];
        }

        emlrtInitCharArrayR2013a(&st, 8, m14, cv80);
        emlrtAssign(&y, m14);
        ...
        emlrt_marshallIn(&b_st, c_sprintf(&b_st, b_sprintf(&b_st, y,
          ...
          emlrt_marshallOut(xnorm), &p_emlrtMCI), "sprintf", cv82);
        st.site = &kc_emlrtRSI;
        b_eml_warning(&st, atmp, cv82);
        exitg1 = true;
      } else {
        atmp++;
        k++;
              ...
              emxArray_real_T *B, emxArray_real_T *Y)
{
  ...
  char_T cv78[21];
  int32_T i;
  static const char_T cv79[21] = { 'C', 'o', 'd', 'e', 'r', ':', 'M', 'A', 'T',
  ...
  if (B->size[0] == A->size[0]) {
    ...
    emlrtInitCharArrayR2013a(sp, 21, m13, cv78);
    emlrtAssign(&y, m13);
    st.site = &eg_emlrtRSI;
    error(&st, message(&st, y, &fb_emlrtMCI), &fb_emlrtMCI);
  }
